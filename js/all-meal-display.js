const announcementsList = document.getElementById('mealsList');
...
const displayAnnouncements = (announcements) => {
    const htmlString = announcements
        .map((announcement) => {
            ...
            <td>
                <button data-toggle="tooltip" title="Düzenle" class="pd-setting-ed"><a href="single-meal-edit.html?mealId=${announcement.id}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></button>
